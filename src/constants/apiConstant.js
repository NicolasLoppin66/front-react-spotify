...
// Url pour les images
export const apiImage = 'http://api_symfony.lndo.site/upload/images/albums';

// Url pour les musique
export const apiMusique = 'http://api_symfony.lndo.site/upload/files/music';